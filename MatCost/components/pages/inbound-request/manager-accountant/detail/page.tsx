...
import { ExportReceiptPdfButton } from "@/components/ui/custom/export-receipt";

export default function AccountantReceiptDetailPage({
  role = "accountant",
}: {
  role?: "accountant" | "admin" | "manager";
}) {
                          ...
                          >
                            <TableCell className="pl-6 py-3">
                              ...
                              <p className="text-[10px] text-slate-500">
                                {rd.materialCode}
                                {rd.materialUnit && ` · ${rd.materialUnit}`}
                              </p>
                            </TableCell>
