...
import { 
  Plus, Search, Calendar, Lock, Unlock, 
  ArrowRight, Bell, User, ClipboardList, CheckCircle2
} from "lucide-react";
...
const AUDIT_SESSIONS = [
  { 
    ...
    date: "2025-10-25", 
    status: "In Progress", // Đang đếm/đối chiếu
    progress: "85%",
    isLocked: true 
  },
  { 
      ...
      <main className="flex-grow flex flex-col overflow-hidden relative z-10">
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/80 sticky top-0 z-30 shadow-sm flex-shrink-0">
          <div className="bg-white px-6 lg:px-8 h-16 flex items-center justify-between">
            <h2 className="text-lg font-semibold text-slate-900">Inventory Audit</h2>
        ...
        <div className="flex-grow overflow-y-auto p-6 lg:p-10 space-y-6">
           ...
           <div className="flex justify-between items-center">
              ...
              <Button 
                onClick={() => router.push('/audit/create')} // Giả lập chuyển trang Create
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="border-l-4 border-l-red-500 shadow-sm">
                 <CardContent className="p-6 flex items-center gap-4">
                    ...
                    <div>
                       <p className="text-sm font-medium text-slate-500">System Locked</p>
                          ...
                          <TableRow key={audit.id} className="group hover:bg-slate-50/50">
                             ...
                             <TableCell>
                                <div className="flex items-center gap-2">
                                   <div className="w-20 bg-slate-100 rounded-full h-2">
                                      <div className="bg-indigo-600 h-2 rounded-full" style={{ width: audit.progress }}></div>
                                   </div>
                             ...
                             <TableCell className="text-right">
                                <Button 
                                  ...
                                  onClick={() => router.push(`/audit/detail`)} // Giả lập vào trang Detail
                                >
                                   {audit.status === 'Completed' ? 'View Report' : 'Reconcile'} 
