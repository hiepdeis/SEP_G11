...
import {
  ...
  Filter,
  Plus,
  UserPlus, // Added icons for the new buttons
} from "lucide-react";
...
export default function StaffMovementListPage() {
  ...
  const handleAssign = () => {
    router.push("stock-movement/assign");
  };

  const handleCreate = () => {
    router.push("stock-movement/create");
  };
        ...
        <div className="flex-grow overflow-y-auto p-4 lg:p-8 space-y-6 pb-24">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              ...
              className="bg-white text-indigo-600 border border-indigo-200 hover:bg-indigo-50 shadow-sm h-12"
            >
              <UserPlus className="w-4 h-4 mr-2" /> Assign Task
            </Button>
            <Button
              onClick={handleCreate}
              className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm h-12"
            >
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="relative flex-grow">
              ...
              <Input
                placeholder="Search Item or Loc..."
                      ...
                      <div className="flex-grow space-y-2">
                        ...
                        <div className="flex items-center justify-between bg-slate-50 p-2 rounded-lg border border-slate-100 text-sm">
                          ...
                          <div className="flex items-center gap-2 text-slate-900">
                            ...
                            <span className="font-bold truncate max-w-[80px] sm:max-w-none">
                              {task.to}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-xs text-slate-500 mt-1">
                          <Truck className="w-3 h-3" /> Qty to move:{" "}
