      ...
      <Dialog open={show2FAPrompt} >
        <DialogContent className="sm:max-w-[450px]">
          <DialogHeader>
            ...
            <DialogTitle className="text-center text-xl">Yêu cầu thiết lập bảo mật</DialogTitle>
            <DialogDescription className="text-center pt-2">
              Tài khoản của bạn có quyền hạn cao (Ký duyệt, Xuất nhập vật tư). 
              Để đảm bảo an toàn cho hệ thống MatCost, vui lòng <b>bật Xác thực 2 lớp (2FA)</b> ngay bây giờ.
            </DialogDescription>
          </DialogHeader>
