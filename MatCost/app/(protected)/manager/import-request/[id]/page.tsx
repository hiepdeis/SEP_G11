              ...
              <Card className="border-slate-200 shadow-sm bg-indigo-50/30 border-indigo-100 gap-0">
                ...
                <CardContent>
                  ...
                  {receipt.status == "Submitted" ? (
                    ...
                    <p className="text-xs text-indigo-600/70 mt-2">
                      {t("This receipt has been approved")}
                    </p>
                  )}
                </CardContent>
              </Card>
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            {t(
                              "Please provide a reason for rejecting this receipt. This will be sent back to the accountant.",
                            )}
                          </DialogDescription>
                        </DialogHeader>
                        <div className="py-4">
                          ...
                          <Textarea
                            placeholder={t(
                              "E.g. Price is too high compared to market...",
                            )}
                            value={rejectReason}
