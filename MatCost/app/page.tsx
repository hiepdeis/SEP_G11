      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 to-slate-900 flex-col justify-between p-12">
        <div>
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-white font-bold text-xl tracking-tight">CWM</span>
          </div>
          <h1 className="text-4xl font-bold text-white mb-3">Construction Warehouse Management</h1>
          <p className="text-slate-300 text-lg">Material import, export and inventory control</p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-xl p-8 sm:p-10 border border-slate-200">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Access System</h2>
            <p className="text-slate-600 mb-8">Sign in to your construction materials warehouse</p>
            ...
            <div className="mt-6 pt-6 border-t border-slate-200">
              <p className="text-xs text-slate-500 text-center">🔒 Enterprise-grade security | Secure authentication</p>
            </div>
          </div>
        </div>
      </div>
