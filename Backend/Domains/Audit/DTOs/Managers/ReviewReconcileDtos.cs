...
public sealed class AuditMetricsDto
{
    ...
    public int CountedMaterials { get; set; }    // Lo?i v?t li?u ?� ??m ???c
    ...
    public decimal TotalVarianceQty { get; set; }   // T?ng ch�nh l?ch = |SystemQty - CountedQty|
    public decimal VariancePercentage { get; set; } // % ch�nh l?ch = (Variance / SystemQty) * 100

    // === T? l? ===
    public decimal MaterialCountRate { get; set; }  // % lo?i v?t li?u ??m ???c
    public decimal MatchRate { get; set; }          // % tr�ng kh?p
}
...
public sealed class AuditDetailedReportDto
{
    ...
    public DateTime? LockedAt { get; set; }
    public DateTime? CompletedAt { get; set; }
    public TimeSpan? TotalDuration { get; set; } // T? l�c b?t ??u ??n ho�n th�nh
...
public sealed class StaffAuditPerformanceDto
{
    ...
    public decimal CountingProgress { get; set; } // % ho�n th�nh
