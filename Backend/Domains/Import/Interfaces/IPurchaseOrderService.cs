...
namespace Backend.Domains.Import.Interfaces
{
    public interface IPurchaseOrderService
    {
        ...
        Task<long> GetLatestRevisionIdAsync(long purchaseOrderId);
        Task<List<PurchaseOrderRevisionHistoryItemDto>> GetRevisionHistoryAsync(long purchaseOrderId);
        Task<PurchaseOrderHistoryResponseDto> GetPurchaseOrderHistoryAsync(long requestId);
    }
}